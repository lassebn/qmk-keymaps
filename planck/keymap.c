...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_planck_grid_wrapper(
    LCTL_T(KC_EXLM), _________NUMS_AND_SYMS_L1_________, _________NUMS_AND_SYMS_R1_________, RCTL_T(KC_DELETE),
    _______,         _________NUMS_AND_SYMS_L2_________, _________NUMS_AND_SYMS_R2_________, RGUI_T(KC_KP_MINUS),
    _______,         _________NUMS_AND_SYMS_L3_________, _________NUMS_AND_SYMS_R3_________, RSFT_T(KC_PLUS),
    _______,         ______________BLANK_______________, KC_NO, _______, KC_0, _______, KC_EQUAL,     _______),
  ...
  [_RAISE] = LAYOUT_planck_grid_wrapper(
    ...
    _______, ____________FUNCTION_L3___________, ______________BLANK_______________, _______,
  ...
  [_LAYER4] = LAYOUT_planck_grid_wrapper(
    ...
    _______, ______________BLANK_______________, ______________BLANK_______________, _______,
    _______, _______, _______, _______, _______, _______, KC_NO,_______, _______, _______, _______,    _______),
